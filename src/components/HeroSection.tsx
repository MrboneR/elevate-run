          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <Card className="p-6 bg-card/80 backdrop-blur-sm border-border/50 transition-performance hover:shadow-performance hover:-translate-y-2">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-card-foreground">{t('hero.adaptiveCoach.title')}</h3>
                <p className="text-muted-foreground text-sm">
                  {t('hero.adaptiveCoach.description')}
                </p>
              </div>
            </Card>
            ...
            <Card className="p-6 bg-card/80 backdrop-blur-sm border-border/50 transition-performance hover:shadow-achievement hover:-translate-y-2">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-card-foreground">{t('hero.smartAdaptation.title')}</h3>
                <p className="text-muted-foreground text-sm">
                  {t('hero.smartAdaptation.description')}
                </p>
              </div>
            </Card>
            ...
            <Card className="p-6 bg-card/80 backdrop-blur-sm border-border/50 transition-performance hover:shadow-glow hover:-translate-y-2">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-card-foreground">{t('hero.injuryPrevention.title')}</h3>
                <p className="text-muted-foreground text-sm">
                  {t('hero.injuryPrevention.description')}
                </p>
              </div>
            </Card>
          </div>
